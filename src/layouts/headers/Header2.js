...
const Header2 = ({ darkHeader, cartButton }) => {
  ...
  return (
    <>
      {/* Header */}
      <header className="website-co-header header--white">
				...
				<div className="container">
					<div className="row">
						...
						<div className="col-8 col-xs-8 col-sm-8 col-md-4 col-lg-6 align-self-center align-center m-align-right">
							...
							{/* Menu Horizontal */}
							<div className="website-co-menu-horizontal">
							...
							{/* Menu Hamburger */}
							<a href="#" className="website-co-menu-btn" style={{"display": "none"}}><span></span></a>
							<div className="website-co-menu-popup align-left">
								<div className="website-co-menu-overlay"></div>
								<div className="website-co-menu-overlay-after"></div>
						...
						<div className="col-4 col-xs-4 col-sm-4 col-md-4 col-lg-3 align-self-center align-right hide-on-mobile-extra">
							...
							{/* Button */}
							<Link className="website-co-btn website-co-hover-btn btn--active" href={appData.header.button2.link}>

...
const Blog2 = ( { posts, totalPosts, currentPage } ) => {
  return (
    <Layouts>
      <PageBanner pageTitle={"Nieuws & Blog"} pageDesc={"Inzichten, Gedachten, Industrietrends, Marketingtips"} />

      {/* website-co Blog List */}
			<div className="website-co-blog website-co-archive gap-top-140">
				<div className="container">
					<div className="row archive-row">
						<div className="col-lg-8">

              {posts.map((item, key) => (
							<div className="website-co-blog-item archive-item" key={`post-${key}`}>
                    ...
                    {item.category}
                      ...
                      {item.short} <br />
							...
							<div className="pager">
								...
								<a className="next page-numbers website-co-next website-co-hover-2" href="#" onClick={(e) => {e.preventDefault();}}><i className="icon-arrow" /></a>
							</div>

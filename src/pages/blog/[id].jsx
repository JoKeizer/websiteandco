...
const PostsDetail = ( props ) => {
  ...
  return (
    <Layouts>
      ...
      {/* website-co Blog Detail */}
			<section className="website-co-section website-co-post gap-top-140">
				<div className="container">

					{/* Image */}
					<div className="website-co-post-pic" data-website-co-overlay data-website-co-scroll>
						<img src={postData.image} alt={postData.title} />
					</div>

					{/* Post*/}
					<div className="website-co-post-wrapper">
						<div className="website-co-post-content">

							{/* Date */}
							<div className="website-co-post-date">
								<span className="date"><Date dateString={postData.date} /></span> by <a href="#" onClick={(e) => {e.preventDefault();}}>{postData.author.name}</a>
							</div>

							{/* Content */}
							<div className="website-co-post-text">
                  ...
                  <>
                    ...
                    <div dangerouslySetInnerHTML={{ __html: postData.additional.content }} />
							...
							{/* Info */}
							<div className="website-co-post-bottom">
								<div className="website-co-post-bottom-content">

									{/* Categories */}
									<div className="website-co-post-categories website-co-lnk lnk--white">
										<span>Posted in: </span>
										<a href="#" onClick={(e) => {e.preventDefault();}}>{postData.category}</a>
									</div>

									{/* Tags */}
									<div className="website-co-post-tags">
										<span>Tags: </span>
                  ...
                  {next_id != 0 && next_id != undefined &&
					...
					{/* Post Comments */}
					<div className="website-co-post-comments">

                    ...
                    <div className="col-xs-12 col-sm-12 col-md-12 col-lg-5">
                        ...
                        <div className="website-co-contact-info website-co-text-white">
                            <ul>
                                <li>
                                    <h5>Contact Info</h5>
                                    <a href="tel:+10204302973" className="website-co-lnk lnk--white" target="_blank">+ 1 (020) 430 2973</a><br/>
                                    <a href="mailto:username@domain.com" className="website-co-lnk lnk--white" target="_blank">username@domain.com</a>
